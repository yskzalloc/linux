...
#[repr(C)]
pub struct S1 { pub a: u64 }
#[repr(C)]
pub struct S2 { pub a: u64, pub b: u64 }
#[repr(C)]
pub struct S3 { pub a: u64, pub b: u64, pub c: u64 }
#[repr(C)]
pub struct S4 { pub a: u64, pub b: u64, pub c: u64, pub d: u64 }
#[repr(C)]
pub struct S5 { pub a: u64, pub b: u64, pub c: u64, pub d: u64, pub e: u64 }
#[repr(C)]
pub struct S6 { pub a: u64, pub b: u64, pub c: u64, pub d: u64, pub e: u64, pub f: u64 }
#[repr(C)]
pub struct S7 { pub a: u64, pub b: u64, pub c: u64, pub d: u64, pub e: u64, pub f: u64, pub g: u64 }
#[repr(C)]
pub struct S8 { pub a: u64, pub b: u64, pub c: u64, pub d: u64, pub e: u64, pub f: u64, pub g: u64, pub h: u64 }

// Recursively nested: StN = { field0, field1: St1, ..., field(N-1): St(N-1) }.
// Copy so a smaller value can be embedded into every larger one.
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St1 { pub field0: u64 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St2 { pub field0: u64, pub field1: St1 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St3 { pub field0: u64, pub field1: St1, pub field2: St2 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St4 { pub field0: u64, pub field1: St1, pub field2: St2, pub field3: St3 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St5 { pub field0: u64, pub field1: St1, pub field2: St2, pub field3: St3, pub field4: St4 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St6 { pub field0: u64, pub field1: St1, pub field2: St2, pub field3: St3, pub field4: St4, pub field5: St5 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St7 { pub field0: u64, pub field1: St1, pub field2: St2, pub field3: St3, pub field4: St4, pub field5: St5, pub field6: St6 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct St8 { pub field0: u64, pub field1: St1, pub field2: St2, pub field3: St3, pub field4: St4, pub field5: St5, pub field6: St6, pub field7: St7 }
...
#[repr(C)]
pub struct Stp1 { pub field0: *const u64 }
#[repr(C)]
pub struct Stp2 { pub field0: *const u64, pub field1: *const Stp1 }
#[repr(C)]
pub struct Stp3 { pub field0: *const u64, pub field1: *const Stp1, pub field2: *const Stp2 }
#[repr(C)]
pub struct Stp4 { pub field0: *const u64, pub field1: *const Stp1, pub field2: *const Stp2, pub field3: *const Stp3 }
#[repr(C)]
pub struct Stp5 { pub field0: *const u64, pub field1: *const Stp1, pub field2: *const Stp2, pub field3: *const Stp3, pub field4: *const Stp4 }
#[repr(C)]
pub struct Stp6 { pub field0: *const u64, pub field1: *const Stp1, pub field2: *const Stp2, pub field3: *const Stp3, pub field4: *const Stp4, pub field5: *const Stp5 }
#[repr(C)]
pub struct Stp7 { pub field0: *const u64, pub field1: *const Stp1, pub field2: *const Stp2, pub field3: *const Stp3, pub field4: *const Stp4, pub field5: *const Stp5, pub field6: *const Stp6 }
#[repr(C)]
pub struct Stp8 { pub field0: *const u64, pub field1: *const Stp1, pub field2: *const Stp2, pub field3: *const Stp3, pub field4: *const Stp4, pub field5: *const Stp5, pub field6: *const Stp6, pub field7: *const Stp7 }

#[no_mangle]
#[inline(never)]
pub extern "C" fn rsf_1(a: *const S1) -> u64 { unsafe { (*a).a } }
...
#[no_mangle]
#[inline(never)]
pub extern "C" fn rsf_4(a: *const S1, b: *const S2, c: *const S3, d: *const S4) -> u64 {
    unsafe { (*a).a + (*b).b + (*c).c + (*d).d }
}

#[no_mangle]
#[inline(never)]
pub extern "C" fn rsf_8(a: *const S1, b: *const S2, c: *const S3, d: *const S4,
                         e: *const S5, f: *const S6, g: *const S7, h: *const S8) -> u64 {
    unsafe { (*a).a + (*b).b + (*c).c + (*d).d + (*e).e + (*f).f + (*g).g + (*h).h }
}
...
#[no_mangle]
#[inline(never)]
pub extern "C" fn rstf_1(p: *const St1) -> u64 { unsafe { (*p).field0 } }

#[no_mangle]
#[inline(never)]
pub extern "C" fn rstf_2(p: *const St2) -> u64 {
    unsafe { (*p).field0 + rstf_1(&(*p).field1) }
}

#[no_mangle]
#[inline(never)]
pub extern "C" fn rstf_3(p: *const St3) -> u64 {
    unsafe { (*p).field0 + rstf_1(&(*p).field1) + rstf_2(&(*p).field2) }
}
...
pub extern "C" fn rstf_6(p: *const St6) -> u64 {
    unsafe {
        (*p).field0 + rstf_1(&(*p).field1) + rstf_2(&(*p).field2)
            + rstf_3(&(*p).field3) + rstf_4(&(*p).field4) + rstf_5(&(*p).field5)
    }
}
...
pub extern "C" fn rstf_8(p: *const St8) -> u64 {
    unsafe {
        (*p).field0 + rstf_1(&(*p).field1) + rstf_2(&(*p).field2)
            + rstf_3(&(*p).field3) + rstf_4(&(*p).field4) + rstf_5(&(*p).field5)
            + rstf_6(&(*p).field6) + rstf_7(&(*p).field7)
    }
}
...
#[no_mangle]
#[inline(never)]
pub extern "C" fn rstpf_1(p: *const Stp1) -> u64 { unsafe { *(*p).field0 } }

#[no_mangle]
#[inline(never)]
pub extern "C" fn rstpf_2(p: *const Stp2) -> u64 {
    unsafe { *(*p).field0 + rstpf_1((*p).field1) }
}

#[no_mangle]
#[inline(never)]
pub extern "C" fn rstpf_3(p: *const Stp3) -> u64 {
    unsafe { *(*p).field0 + rstpf_1((*p).field1) + rstpf_2((*p).field2) }
}
...
pub extern "C" fn rstpf_6(p: *const Stp6) -> u64 {
    unsafe {
        *(*p).field0 + rstpf_1((*p).field1) + rstpf_2((*p).field2)
            + rstpf_3((*p).field3) + rstpf_4((*p).field4) + rstpf_5((*p).field5)
    }
}
...
pub extern "C" fn rstpf_8(p: *const Stp8) -> u64 {
    unsafe {
        *(*p).field0 + rstpf_1((*p).field1) + rstpf_2((*p).field2)
            + rstpf_3((*p).field3) + rstpf_4((*p).field4) + rstpf_5((*p).field5)
            + rstpf_6((*p).field6) + rstpf_7((*p).field7)
    }
}
...
fn build_and_run_stp8() -> Result<u64> {
    ...
    let p1 = KBox::new(Stp1 { field0: &*l1 }, kernel::alloc::flags::GFP_KERNEL)?;
    let p2 = KBox::new(Stp2 { field0: &*l2, field1: &*p1 }, kernel::alloc::flags::GFP_KERNEL)?;
    let p3 = KBox::new(Stp3 { field0: &*l3, field1: &*p1, field2: &*p2 }, kernel::alloc::flags::GFP_KERNEL)?;
    let p4 = KBox::new(Stp4 { field0: &*l4, field1: &*p1, field2: &*p2, field3: &*p3 }, kernel::alloc::flags::GFP_KERNEL)?;
    let p5 = KBox::new(Stp5 { field0: &*l5, field1: &*p1, field2: &*p2, field3: &*p3, field4: &*p4 }, kernel::alloc::flags::GFP_KERNEL)?;
    let p6 = KBox::new(Stp6 { field0: &*l6, field1: &*p1, field2: &*p2, field3: &*p3, field4: &*p4, field5: &*p5 }, kernel::alloc::flags::GFP_KERNEL)?;
    let p7 = KBox::new(Stp7 { field0: &*l7, field1: &*p1, field2: &*p2, field3: &*p3, field4: &*p4, field5: &*p5, field6: &*p6 }, kernel::alloc::flags::GFP_KERNEL)?;
    let p8 = KBox::new(Stp8 { field0: &*l8, field1: &*p1, field2: &*p2, field3: &*p3, field4: &*p4, field5: &*p5, field6: &*p6, field7: &*p7 }, kernel::alloc::flags::GFP_KERNEL)?;
...
#[no_mangle]
#[inline(never)]
pub extern "C" fn rsf_fwd_inner(a: *const S1, b: *const S2, c: *const S3, d: *const S4) -> u64 {
    unsafe { (*a).a + (*b).b + (*c).c + (*d).d }
}

#[no_mangle]
#[inline(never)]
pub extern "C" fn rsf_fwd(a: *const S1, b: *const S2, c: *const S3, d: *const S4) -> u64 {
    rsf_fwd_inner(a, b, c, d)
}

/* Struct return value */
#[no_mangle]
#[inline(never)]
pub extern "C" fn rsf_ret_struct(a: *const S1, b: *const S2) -> S4 {
    unsafe {
...
unsafe extern "C" fn write_handler(
    ...
    let v7 = S7 { a: 0x11, b: 0x22, c: 0x33, d: 0x44, e: 0x55, f: 0x66, g: 0x77 };
    let v8 = S8 { a: 0x11, b: 0x22, c: 0x33, d: 0x44, e: 0x55, f: 0x66, g: 0x77, h: 0x88 };
    ...
    let t5 = St5 { field0: 0x55, field1: t1, field2: t2, field3: t3, field4: t4 };
    let t6 = St6 { field0: 0x66, field1: t1, field2: t2, field3: t3, field4: t4, field5: t5 };
    let t7 = St7 { field0: 0x77, field1: t1, field2: t2, field3: t3, field4: t4, field5: t5, field6: t6 };
    let t8 = St8 { field0: 0x88, field1: t1, field2: t2, field3: t3, field4: t4, field5: t5, field6: t6, field7: t7 };

    let mut sum: u64 = 0;
    sum = sum.wrapping_add(rsf_1(&v1 as *const S1));
    sum = sum.wrapping_add(rsf_2(&v1 as *const S1, &v2 as *const S2));
    sum = sum.wrapping_add(rsf_4(&v1 as *const S1, &v2 as *const S2, &v3 as *const S3, &v4 as *const S4));
    sum = sum.wrapping_add(rsf_8(&v1 as *const S1, &v2 as *const S2, &v3 as *const S3, &v4 as *const S4,
                                  &v5 as *const S5, &v6 as *const S6, &v7 as *const S7, &v8 as *const S8));
    ...
    sum = sum.wrapping_add(rsf_fwd(
        &v1 as *const S1, &v2 as *const S2,
    ...
    if let Ok(s) = build_and_run_stp8() {
