 ...
 * (defined in <linux/kcov.h>), which records into whichever collector this task
 * has enabled -- mainline kcov OR kcov-dataflow. kcov.c never names the dataflow
 * side; that split lives entirely in the header.
 */
